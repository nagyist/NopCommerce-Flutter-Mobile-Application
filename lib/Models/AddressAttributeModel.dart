...
import 'AddressAttributesValuesModel.dart';
...
class AddressAttribute {
  ...
  factory AddressAttribute.fromJson(Map<String, dynamic> json) => AddressAttribute(
    name: json["Name"],
    isRequired: json["IsRequired"],
    defaultValue: json["DefaultValue"],
    attributeControlType: json["AttributeControlType"],
    values: List<AddressAttributesValues>.from(json["Values"].map((x) => AddressAttributesValues.fromJson(x))),
    id: json["Id"],
