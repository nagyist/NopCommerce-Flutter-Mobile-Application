...
import 'package:nopcommerce/Themes/Flexo/Screen/Catalog/SearchProducts/SearchProducts.dart';
...
class SearchProducts extends StatefulWidget {
  ...
  SearchProducts({required this.searchTerms, required this.isAppBarSearch});
...
class _SearchProductsState extends State<SearchProducts> {
  ...
  loadData() async
  {
    ...
    {
      context.read<SearchProductsProvider>().pageLoadData(context: context,searchTerms: widget.searchTerms,isAppBarSearch: widget.isAppBarSearch);
    }
  }
