...
import 'package:nopcommerce/Themes/Flexo/Screen/Customer/Avatar/Avatar.dart';
import 'package:nopcommerce/Utils/Enum/ThemeAttributes.dart';
import 'package:nopcommerce/Screens/General/LocalResourceProvider.dart';
import 'package:provider/provider.dart';
import 'AvatarProvider.dart';
...
class _AvatarState extends State<Avatar> {
  ...
  loadData()async
  {
    ...
    context.read<AvatarProvider>().loadCacheData(context: context);
    if(await CheckConnectivity().checkInternet(context))
    {
      context.read<AvatarProvider>().pageLoadData(context: context);
    }
  }
  @override
