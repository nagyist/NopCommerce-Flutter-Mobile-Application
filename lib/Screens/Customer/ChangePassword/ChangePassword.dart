...
import 'package:nopcommerce/Themes/Flexo/Screen/Customer/ChangePassword/ChangePassword.dart';
...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  loadData()async
  {
    ...
    context.read<ChangePasswordProvider>().loadCacheData(context: context);
    if(await CheckConnectivity().checkInternet(context))
    {
       context.read<ChangePasswordProvider>().pageLoadData(context: context);
    }
  }
