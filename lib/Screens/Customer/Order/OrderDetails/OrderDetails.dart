...
import 'package:nopcommerce/Themes/Flexo/Screen/Customer/Order/OrderDetail/OrderDetails.dart';
...
class _OrderDetailsState extends State<OrderDetails>{
  ...
  loadData()async
  {
    ...
    if(await CheckConnectivity().checkInternet(context)){
      context.read<OrderDetailsProvider>().pageLoadData(context: context);
      context.read<OrderDetailsProvider>().getOrderDetailsData(context: context,orderId: widget.orderId);
    }
  }
