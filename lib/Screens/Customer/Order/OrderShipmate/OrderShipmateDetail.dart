...
import 'package:nopcommerce/Themes/Flexo/Screen/Customer/Order/OrderShipmate/OrderShipmateDetail.dart';
...
class _OrderShipmateDetailState extends State<OrderShipmateDetail> {
  ...
  loadData ()async
  {
    ...
    if(await CheckConnectivity().checkInternet(context) ){
       context.read<OrderShipmateDetailProvider>().pageLoadData(context: context);
       context.read<OrderShipmateDetailProvider>().getOrderShipmentDetailsData(context: context, shipmateId: widget.id);
    }
  }
