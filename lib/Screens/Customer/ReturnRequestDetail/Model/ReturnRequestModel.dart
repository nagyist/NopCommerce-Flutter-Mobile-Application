...
ReturnRequestModel returnRequestModelFromJson(String str) => ReturnRequestModel.fromJson(json.decode(str));

String returnRequestModelToJson(ReturnRequestModel data) => json.encode(data.toJson());
...
class ReturnRequestModel {
  ...
  factory ReturnRequestModel.fromJson(Map<String, dynamic> json) => ReturnRequestModel(
