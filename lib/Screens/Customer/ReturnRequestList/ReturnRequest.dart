...
import 'package:nopcommerce/Themes/Flexo/Screen/Customer/ReturnRequestList/ReturnRequestList.dart';
...
class _ReturnRequestState extends State<ReturnRequest> {
  ...
  loadData()async
  {
    ...
    if(await CheckConnectivity().checkInternet(context)){
      context.read<ReturnRequestProvider>().pageLoadData(context: context);
    }
  }
  @override
