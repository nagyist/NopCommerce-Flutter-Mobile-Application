...
import 'package:nopcommerce/Themes/Flexo/Screen/General/ContactUs/ContactUs.dart';
...
class _ContactUsState extends State<ContactUs> {
  ...
  loadData() async
  {
    ...
    context.read<ContactUsProvider>().loadCacheData(context: context);
    if(await CheckConnectivity().checkInternet(context))
    {
      context.read<ContactUsProvider>().pageLoadData(context: context);
    }
  }
