...
List<GetHomepageBestSellersModel> getHomepageBestSellersModelFromJson(String str) => List<GetHomepageBestSellersModel>.from(json.decode(str).map((x) => GetHomepageBestSellersModel.fromJson(x)));

String getHomepageBestSellersModelToJson(List<GetHomepageBestSellersModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetHomepageBestSellersModel {
  GetHomepageBestSellersModel({
    required this.name,
  ...
  factory GetHomepageBestSellersModel.fromJson(Map<String, dynamic> json) => GetHomepageBestSellersModel(
    name: json["Name"],
