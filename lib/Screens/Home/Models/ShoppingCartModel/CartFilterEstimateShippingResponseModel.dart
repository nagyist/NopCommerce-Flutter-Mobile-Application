...
CartFilterEstimateShippingResponseModel cartFilterEstimateShippingResponseModelFromJson(String str) => CartFilterEstimateShippingResponseModel.fromJson(json.decode(str));

String cartFilterEstimateShippingResponseModelToJson(CartFilterEstimateShippingResponseModel data) => json.encode(data.toJson());

class CartFilterEstimateShippingResponseModel {
  CartFilterEstimateShippingResponseModel({
  ...
  factory CartFilterEstimateShippingResponseModel.fromJson(Map<String, dynamic> json) => CartFilterEstimateShippingResponseModel(
