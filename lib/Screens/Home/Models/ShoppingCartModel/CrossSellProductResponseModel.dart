...
List<CrossSellProductResponseModel> crossSellProductResponseModelFromJson(String str) => List<CrossSellProductResponseModel>.from(json.decode(str).map((x) => CrossSellProductResponseModel.fromJson(x)));

String crossSellProductResponseModelToJson(List<CrossSellProductResponseModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CrossSellProductResponseModel {
  CrossSellProductResponseModel({
    required this.name,
  ...
  factory CrossSellProductResponseModel.fromJson(Map<String, dynamic> json) => CrossSellProductResponseModel(
    name: json["Name"],
