...
import 'package:nopcommerce/Themes/Flexo/Screen/Product/EmailProduct/EmailProduct.dart';
...
class EmailProduct extends StatefulWidget {
  final int productID;
  EmailProduct({required this.productID});

  @override
  State<EmailProduct> createState() => _EmailProductState();
}

class _EmailProductState extends State<EmailProduct> {
  @override
  void initState() {
  ...
  loadData() async
  {
    ...
    {
      context.read<EmailProductProvider>().pageLoadData(context: context,productID: widget.productID);
    }
  }
