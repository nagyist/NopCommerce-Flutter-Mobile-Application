...
List<GetRelatedProductsModel> getRelatedProductsModelFromJson(String str) => List<GetRelatedProductsModel>.from(json.decode(str).map((x) => GetRelatedProductsModel.fromJson(x)));

String getRelatedProductsModelToJson(List<GetRelatedProductsModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetRelatedProductsModel {
  ...
  factory GetRelatedProductsModel.fromJson(Map<String, dynamic> json) => GetRelatedProductsModel(
    name: json["Name"],
