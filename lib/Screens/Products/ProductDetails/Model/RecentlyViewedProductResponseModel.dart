...
List<RecentlyViewedProductResponseModel> recentlyViewedProductResponseModelFromJson(String str) => List<RecentlyViewedProductResponseModel>.from(json.decode(str).map((x) => RecentlyViewedProductResponseModel.fromJson(x)));

String recentlyViewedProductResponseModelToJson(List<RecentlyViewedProductResponseModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RecentlyViewedProductResponseModel {
  RecentlyViewedProductResponseModel({
    required this.name,
  ...
  factory RecentlyViewedProductResponseModel.fromJson(Map<String, dynamic> json) => RecentlyViewedProductResponseModel(
    name: json["Name"],
