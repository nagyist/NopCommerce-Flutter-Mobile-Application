...
import 'package:nopcommerce/Themes/Flexo/Screen/Wishlist/Wishlist/Wishlist.dart';
...
class _WishlistState extends State<Wishlist> {
  ...
  loadData() async
  {
    ...
    context.read<WishlistProvider>().loadCacheData(context: context);
    if(await CheckConnectivity().checkInternet(context))
    {
      context.read<WishlistProvider>().pageLoadData(context: context);
    }
  }
