      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: FlexoTextWidget().headingBoldText16(text: localResourceProvider.getResourseByKey('products.relatedProducts'),),
          ),
          ...
          Container(
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: Row(
                  children: productDetailsProvider.getRelatedProductsModel.map((e){
                    return Container(
